...
abstract_screener(file = 'effort_Colton.csv', aReviewer = 'Colton', abstractColumnName = 'AB', titleColumnName = 'TI', windowWidth = 120, highlightKeywords = c("metabol", "metagenom", "bacteria", "colon", "rectal", "gut", "bile", "fatty", "choline"))
```
